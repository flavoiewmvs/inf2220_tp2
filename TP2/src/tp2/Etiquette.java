 ...
 *
 * Une étiquette est simplement un identificateur, représenté par une chaine de caractères, et un intervalle,
 * représenté par deux valeurs : la position de la première case et de la dernière case. L’intervalle est inclusif.
 * Cette classe contient aussi des comparateurs d’intervalles.
 */
package tp2;
